...
check(
  participationUnitsEs.map((unit) => unit.number).join(",") === "1,2,3,4" &&
  ...
  "Participación deriva sus temas de las cuatro unidades desarrolladas, no de un import directo de una unidad."
);
