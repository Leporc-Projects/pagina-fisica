...
check(
  participationUnitsEs.map((unit) => unit.number).join(",") === "1,2,3,4,5,6,7" &&
  ...
  "Participación deriva sus temas de las siete unidades desarrolladas, no de un import directo de una unidad."
);
